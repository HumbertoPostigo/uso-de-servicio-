...
//Función que activa una función del servicio Prueba
  activar_invocable1(){
  ...
  activar_invocablesumar2(){
    let dato_desde_servicio = this.pruebaSrv.sumar2(3,6);
    console.log(dato_desde_servicio);
  }

  activar_promedio(){
    let dato_desde_servicio = this.pruebaSrv.promedio(3,5);
